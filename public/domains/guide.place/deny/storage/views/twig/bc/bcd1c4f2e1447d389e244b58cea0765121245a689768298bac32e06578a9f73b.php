...
";
            // line 41
            $this->loadTemplate("header", "layouts.search_places_twig_vue", 41)->display($context);
            // line 42
            echo "
...
\t\t\t\t\t\t\t";
            // line 97
            $this->loadTemplate("cityswitcher", "layouts.search_places_twig_vue", 97)->display($context);
            // line 98
            echo "\t\t\t\t\t\t\t<div>
\t\t\t\t\t\t\t<button class=\"icon-btn filter_btn\" @click=\"isCatFiltersShow = !isCatFiltersShow\">
...
\t\t\t\t\t\t\t";
            // line 165
            $this->loadTemplate("item_vue", "layouts.search_places_twig_vue", 165)->display($context);
            // line 166
...
";
            // line 310
            $this->loadTemplate("footer", "layouts.search_places_twig_vue", 310)->display($context);
            // line 311
            echo "
";
        }
