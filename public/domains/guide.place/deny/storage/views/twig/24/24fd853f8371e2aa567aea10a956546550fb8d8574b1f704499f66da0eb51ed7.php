...
\t\t\t\t\t\t<v-date-picker :min-date='new Date()' :columns=\"2\" is-range v-model=\"myRouteDates\" @input=\"setMyRouteDays\">
...
\t\t\t\t\t\t</v-date-picker>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"route-calendar__list\">
\t\t\t\t\t\t<div class=\"route-calendar__listitem\" v-for=\"(day, dayIndex) in myRouteItems\" ";
        // line 213
        echo ">
...
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t\t<div class=\"vsearch-recs\" v-if=\"myRouteRecommendations.length\">
\t\t\t\t\t<div class=\"vsearch-hat__header\">
\t\t\t\t\t\t<h2 class=\"vsearch-hat__title\">Рекомендации</h2>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"vsearch-recs-slider\">
\t\t\t\t\t\t<div class=\"vsearch-recs-slider-main splide\">
\t\t\t\t\t\t  \t<div class=\"splide__track\">
\t\t\t\t\t\t\t\t<div class=\"splide__list\">
\t\t\t\t\t\t\t\t\t<div class=\"splide__slide vsearch-recs-slider__slide\" v-for=\"recItem in myRouteRecommendations\" :key=\"recItem.id\">
\t\t\t\t\t\t\t\t\t\t<div class=\"vsearch-recs-card\">
\t\t\t\t\t\t\t\t\t\t\t<div class=\"vsearch-recs-card__img\">
\t\t\t\t\t\t\t\t\t\t\t\t<img :src=\"'/site/data/images/medium/' + recItem.field_image\">
\t\t\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t<div class=\"search-day\" v-for=\"(day, dayIndex) in myRouteItems\">
...
<script src=\"/site/theme/js/russpass.js\"></script>
";
        // line 1126
        $this->loadTemplate("footer", "layouts.myroute", 1126)->display($context);
    }
    ...
    {
        return array (  632 => 1126,  506 => 1003,  501 => 1001,  474 => 976,  439 => 736,  418 => 716,  393 => 667,  386 => 659,  339 => 611,  221 => 459,  194 => 431,  186 => 408,  167 => 365,  161 => 338,  146 => 283,  117 => 220,  111 => 213,  62 => 166,  60 => 141,  57 => 140,  54 => 73,  48 => 3,  45 => 2,  43 => 1,);
    }
}
/* {% include 'header' %}*/
/*  */
...
/* 					</div>*/
/* 					<div class="route-calendar__list">*/
/* 						<div class="route-calendar__listitem" v-for="(day, dayIndex) in myRouteItems" {#@click.stop="myRouteSelectedDay = dayIndex"#}>*/
/* 							{{ getDateText(day.date) }}*/
/* 						</div>*/
/* 					</div>*/
/* 					{#*/
